  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          <motion.div
            className="fixed inset-0 z-[70] bg-foreground/40 backdrop-blur-lg"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          />
          <motion.div
            className="fixed inset-x-0 top-0 z-[71] bg-background/98 backdrop-blur-xl shadow-[0_20px_60px_-15px_hsl(var(--foreground)/0.1)] max-h-[85svh] overflow-y-auto"
